...
### 2. Exploratory Data Analysis (EDA)
   ...
   1. Melihat 5 data teratas
      ...
      ```
      ![image](https://user-images.githubusercontent.com/74480780/124726805-4bee4080-df38-11eb-8a99-0632f0fdc24e.png)
   2. Melihat tipe data tiap kolom/feature
      ``
      df.info()
      ``
   ...
   5. Melihat data NULL dalam dataset
      ```
      df.isnull().sum()
      ```
   ...
   6. Melihat korelasi/hubungan antar kolom/feature
      ```
      df.corr()
      ```
   ...
   7. Menambahkan kolom tahun pada dataset
      ```
